    ...
    >
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mx-auto mt-8 inline-block rotate-1 rounded-3xl border-4 border-fun-ink bg-fun-yellow px-6 py-4 font-display text-lg font-bold text-fun-ink shadow-[6px_6px_0_rgb(0_0_0_/_0.85)] md:text-xl max-w-2xl">
            {about.intro}
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3">
          {about.cards.map((card) => {
            ...
            return (
              <div
                key={card.color}
                className={`group relative ${card.rotation} transition-transform duration-300 hover:-translate-y-2 hover:rotate-0 hover:scale-105`}
              >
                {/* Card */}
                <div
                  ...
                  {card.image ? (
                    <>
                      ...
                      <div className="absolute inset-x-4 bottom-4 z-10">
                        <div className="rounded-[28px] border-4 border-fun-ink bg-white/95 px-5 py-4 text-center shadow-[5px_5px_0_rgb(0_0_0_/_0.25)] backdrop-blur-sm">
                          <h3 className="font-display text-2xl font-bold text-fun-ink md:text-3xl">{card.title}</h3>

                          <p className="mt-2 font-display text-base font-semibold text-fun-ink/80 md:text-lg">
                            {card.subtitle}
                          </p>
                        </div>
                      </div>
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="font-display text-base font-semibold text-fun-ink/70 md:text-lg">{card.subtitle}</p>
                </div>
              </div>
            );
          })}
